...
#     """
#     Process Round 1A: Extract outlines from PDFs using the new offline-first,
#     high-accuracy extractor.
#     """
#     print("Starting Round 1A: Advanced Document Outline Extraction (Offline Optimized)")
    
#     # Use the new, improved OutlineExtractor
...
#         try:
#             # Extract outline using the new method
...
# # def process_round1b(input_dir: str, output_dir: str, persona: str = None, job_description: str = None):
#     """Process Round 1B: Persona-driven document analysis"""
#     print("Starting Round 1B: Persona-Driven Document Intelligence")
...
#     # Use command line arguments if provided, otherwise use job_config.json
#     if persona and job_description:
#         job_config = {
#             "persona": persona,
#             "job_description": job_description
#         }
#         print(f"✓ Using command line persona: {persona}")
#     elif job_config_file.exists():
#         with open(job_config_file, 'r', encoding='utf-8') as f:
#             job_config_data = json.load(f)
#             # Handle array format from your job_config.json
#             if isinstance(job_config_data, list):
#                 job_config = job_config_data[0]  # Use first persona
#             else:
#                 job_config = job_config_data
#         print(f"✓ Using job_config.json")
#     else:
#         print("❌ No persona/job description provided via command line or job_config.json")
#         return
...
#     #                     help='User persona description (for Round 1B)')
#     # parser.add_argument('--job-description', '--job', default=None,
...
"""
Main entry point for Adobe India Hackathon PDF Intelligence System
Handles Round 1A (outline extraction) only - optimized for offline use
"""
...
def main():
    """Main execution function"""
    parser = argparse.ArgumentParser(description='Adobe India Hackathon PDF Intelligence System - Round 1A')
    parser.add_argument('--round', choices=['1a'], default='1a',
                        help='Round to execute (only 1a for outline extraction)')
    ...
    # Process Round 1A only
    if args.round == '1a':
        process_round1a(args.input, args.output)
    else:
        print("❌ Only Round 1A is supported in this version")
        sys.exit(1)
